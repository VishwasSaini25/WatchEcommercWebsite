...
$(".btn, .card-link, .compare-ahead").click(function(){
    alert("This is a preview website");
})
...
$(".submit-button").click(function(){
    $(".submit-button").addClass("animate-button");
    setTimeout(function(){
        $(".submit-button").removeClass("animate-button");  
...
$(".exerc").click(function(){
    ...
    $(".fitness-img-r").addClass("animate-fitness-image"); 
    setTimeout(function(){
        $(".fitness-img-r").removeClass("animate-fitness-image");  
